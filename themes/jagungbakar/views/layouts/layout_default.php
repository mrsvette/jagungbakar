...
<head>
	...
	<link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl.'/css'; ?>/jagungbakar/js/vendor/owl-carousel/owl.carousel.css" media="screen">
	<link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl.'/css'; ?>/jagungbakar/js/vendor/owl-carousel/owl.theme.css" media="screen">
	<link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl.'/css'; ?>/jagungbakar/js/vendor/owl-carousel/owl.transitions.css" media="screen">
	...
	<link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl.'/css'; ?>/jagungbakar/css/font-awesome.min.css" type="text/css" media="screen">
...
<div class="body">
	<div class="main-wrap container">
		<div class="row">
			<div class="col-md-9 ts-main-left">
					...
					<div class="container">
						<div class="row">
							...
							<div class="col-md-6 text-right">
								<?php $this->widget('bannerWidget',array('key'=>'banner_1','htmlOptions'=>array('class'=>'img-responsive')));?>
							</div>
						</div>
					</div>
				</header>
				...
				<?php $this->widget('ext.flexslider.FlexSlider',array('imageList'=>NivoSlider::flexSlider(),'slideshowSpeed'=>5000));?>
						...
						<div class="col-md-12">
							<div id="tabwrap">
								...
								<div id="3">
									...
									<?php $this->widget('SearchWidget',array('placeholder'=>'Search Site','destination'=>'#home-blog'));?>
								</div>
							</div>
						</div>
	...
	<script src="<?php echo Yii::app()->request->baseUrl.'/css'; ?>/jagungbakar/js/main.js" id="app-js"></script>
