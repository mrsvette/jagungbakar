...
/**
 * This is the model class for table "{{mod_gallery_category}}".
 *
 * The followings are the available columns in table '{{mod_gallery_category}}':
 * @property string $id
 ...
 */
class ModGalleryCategory extends CActiveRecord
{
	/**
	...
	public function attributeLabels()
	{
		return array(
			'id' => 'ID',
			'title' => Yii::t('GalleryModule.gallery','Category Title'),
			'slug' => 'Slug',
	 ...
	 * @return ModGalleryCategory the static model class
	 */
