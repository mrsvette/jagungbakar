				...
				array(
					...
					'buttons'=>array(
						'delete'=>array(
							...
							'url'=>'Yii::app()->createUrl("/appadmin/products/deleteImage2", array("id"=>$data->id))',
		...
		<?php
			$this->widget('ext.EAjaxUpload.EAjaxUpload',
				array(
					'id'=>'uploadFile',
					'config'=>array(
						'action'=>Yii::app()->createUrl('/appadmin/products/createImage',array('id'=>$item->id)),
