...
$this->menu=array(
	array('label'=>Yii::t('global','List').' Catalogue', 'url'=>array('view')),
	array('label'=>Yii::t('global','Create').' Catalogue', 'url'=>array('create')),
);
...
<div class="panel panel-default">
	<div class="panel-heading">
		...
		<h4 class="panel-title"><?php echo Yii::t('global','Manage');?> Catalogue</h4>
	</div>
		...
		<?php $this->widget('zii.widgets.grid.CGridView', array(
			...
			'columns'=>array(
				...
				array(
					'name'=>'src',
					'type'=>'raw',
					'value'=>'CHtml::image(Yii::app()->request->baseUrl."/".$data->src,$data->key,array(\'width\'=>\'150px\'))',
				),
				array(
					'name'=>'type',
					'type'=>'raw',
				...
				array(
					'name'=>'file_id',
					'type'=>'raw',
					'value'=>'$data->file_rel->file_name',
					'filter'=>CHtml::activeTextField($model,'file'),
				),
				array(
					'class'=>'CButtonColumn',
