...
?>
<link href="<?php echo Yii::app()->request->baseUrl.'/css'; ?>/bracket/css/morris.css" rel="stylesheet">
<div class="row">
...
<script async src="<?php echo Yii::app()->request->baseUrl.'/css'; ?>/bracket/js/morris.min.js"></script>
<script async src="<?php echo Yii::app()->request->baseUrl.'/css'; ?>/bracket/js/raphael-2.1.0.min.js"></script>
...
function draw_chart(){
	$.ajax({
		'url': "<?php echo Yii::app()->createUrl('/appadmin/analytics/pageViewInterval');?>",
		'dataType': 'json',
		'type':'post',
