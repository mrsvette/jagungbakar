...
<script src="<?php echo Yii::app()->request->baseUrl.'/css'; ?>/bracket/js/flot/flot.min.js"></script>
<script src="<?php echo Yii::app()->request->baseUrl.'/css'; ?>/bracket/js/flot/flot.pie.min.js"></script>
