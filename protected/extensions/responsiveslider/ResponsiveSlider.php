<?php
/*
 * ResponsiveSlider widget class file.
...
class ResponsiveSlider extends CWidget
{
	...
	public function publishAssets()
	{
		...
		if(is_dir($assets)){
			...
			Yii::app()->clientScript->registerCssFile($baseUrl . '/responsive-slider.css');
			Yii::app()->clientScript->registerScriptFile($baseUrl . '/jquery.event.move.js',CClientScript::POS_END);
			Yii::app()->clientScript->registerScriptFile($baseUrl . '/responsive-slider.js',CClientScript::POS_END);
		} else {
