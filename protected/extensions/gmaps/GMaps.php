...
class GMaps extends CWidget
{
	...
	protected static function publishAssets()
	{
		...
		if(is_dir($assets)){
			...
			Yii::app()->clientScript->registerScriptFile('http://maps.googleapis.com/maps/api/js',CClientScript::POS_END);
			Yii::app()->clientScript->registerScriptFile($baseUrl.'/gmaps.min.js',CClientScript::POS_END);
		} else {
